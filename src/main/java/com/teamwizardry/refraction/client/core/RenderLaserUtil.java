...
public class RenderLaserUtil {
	...
	public static void renderLaser(Color color, Vec3d start, Vec3d end, BufferBuilder bb) {
		...
		Vec3d d = new Vec3d(0, (0.25 * color.getAlpha() / 255D) / 2.0, 0);
		Vec3d d2 = new Vec3d((0.25 * color.getAlpha() / 255D) / 2.0, 0, 0);
		Vec3d d3 = new Vec3d(0, 0, (0.25 * color.getAlpha() / 255D) / 2.0);
