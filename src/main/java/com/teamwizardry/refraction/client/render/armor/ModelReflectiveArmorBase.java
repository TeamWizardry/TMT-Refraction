 ...
 * Created by LordSaad.
 */
public class ModelReflectiveArmorBase extends ModelBiped {
    ...
    public ModelReflectiveArmorBase(EntityEquipmentSlot slot) {
    ...
    @Override
    public void render(@NotNull Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float netHeadPitch, float scale) {
