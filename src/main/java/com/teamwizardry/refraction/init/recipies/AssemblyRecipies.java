...
public class AssemblyRecipies {
	...
	public static void init() {
		...
		recipes.add(new AssemblyRecipe(new ItemStack(ModBlocks.PRISM), new Color(0x8C9B9B9B, true), new Color(0xCCC3C3C3, true), ModBlocks.LENS, ModBlocks.LENS, ModBlocks.LENS, ModBlocks.LENS, ModBlocks.LENS, ModBlocks.LENS));
		...
		recipes.add(new AssemblyRecipe(new ItemStack(ModBlocks.REF_CHAMBER), new Color(0x80FF6400, true), new Color(0xBFFF0096, true), ModBlocks.LENS, ModBlocks.LENS, ModBlocks.LENS, ModBlocks.LENS, ModBlocks.LENS, ModBlocks.LENS, ModItems.REFLECTIVE_ALLOY, ModItems.REFLECTIVE_ALLOY, ModItems.REFLECTIVE_ALLOY, ModItems.REFLECTIVE_ALLOY, ModItems.REFLECTIVE_ALLOY, Items.IRON_INGOT, Items.IRON_INGOT, Items.IRON_INGOT));
