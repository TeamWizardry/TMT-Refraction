...
public final class ConfigValues {
    ...
    @ConfigPropertyInt(modid = Constants.MOD_ID, category = "general", id = "disco_ball_beam_bounce_limit", comment = "The disco ball's beams have a bounce/reflecting limit of 4 times. This is to prevent tps drops. This number is kind of a sweet spot in an enclosed cube of reflective alloy gravityProtection. If you set it to a higher value, it will reflect a lot more beams but will drop your tps if you cannot handle it.", defaultValue = 4)
