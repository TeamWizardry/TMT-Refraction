...
public final class ConfigValues {
	...
	@ConfigPropertyInt(modid = Constants.MOD_ID, category = "general", id = "solar_strength", comment = "This will specify the strength the sun will provide to blocks like the magnifier. Max: 255", defaultValue = 16)
	public static int SOLAR_ALPHA;
	@ConfigPropertyInt(modid = Constants.MOD_ID, category = "general", id = "glowstone_strength", comment = "This will specify the strength glowstone will provide to blocks like the laser. Max: 255 ", defaultValue = 64)
