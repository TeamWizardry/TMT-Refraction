...
public class Constants {
	...
	@ConfigPropertyInt(modid = Refraction.MOD_ID, category = "general", id = "solar_strength", comment = "This will specify the strength the sun will provide to blocks like the magnifier. Max: 255", defaultValue = 16)
